const moves = [
    ...
    { name: "Vital Throw", type: "Fighting", dice: ["Atk", "Forçar"], base: 7, notes: ["swift", "low-prio"] },
    ...
    { name: "Snore", type: "Normal", dice: ["Int", "Estrelar"], base: 2, notes: ['snore', 'sound'] },
    { name: "Sparkling Aria", type: "Water", dice: ["Int", "Estrelar"], base: 9, notes: ['sound', 'brn-heal'] },
    { name: "Shell Trap", type: "Fire", dice: ["Int", "Criar"], base: 15, notes: ['shell-trap', 'low-prio'] },
    { name: "Thunder Cage", type: "Electric", dice: ["Int", "Criar"], base: 8, notes: ['trap'] },
    { name: "Dragon Energy", type: "Dragon", dice: ["Int", "Criar"], base: NaN, notes: ['eruption'] },
    { name: "Freezing Glare", type: "Psychic", dice: ["Int", "Criar"], base: 9, notes: ['frz10'] },
    { name: "Fiery Wrath", type: "Dark", dice: ["Int", "Criar"], base: 9, notes: ['flinch20'] },
    { name: "Astral Barrage", type: "Ghost", dice: ["Int", "Criar"], base: 12 },
    { name: "Eerie Spell", type: "Psychic", dice: ["Int", "Criar"], base: 8, notes: ['spite', 'sound'] },
    { name: "Springtide Storm", type: "Fairy", dice: ["Int", "Criar"], base: 10, notes: ['atk30', 'thunder'] },
    { name: "Mystical Power", type: "Psychic", dice: ["Int", "Criar"], base: 7, notes: ['spaup100'] },
    { name: "Chloroblast", type: "Grass", dice: ["Int", "Criar"], base: 15, notes: ['recoil2'] },
    { name: "Esper Wing", type: "Psychic", dice: ["Int", "Criar"], base: 8, notes: ['high-crit'] },
    { name: "Bitter Malice", type: "Ghost", dice: ["Int", "Criar"], base: 7, notes: ['atkdown100'] },
    { name: "Infernal Parade", type: "Ghost", dice: ["Int", "Criar"], base: 6, notes: ['brn30', 'hex'] },
    { name: "Bleakwind Storm", type: "Flying", dice: ["Int", "Criar"], base: 10, notes: ['speed30', 'thunder'] },
    { name: "Wildbolt Storm", type: "Electric", dice: ["Int", "Criar"], base: 10, notes: ['par30', 'thunder'] },
    { name: "Sandsear Storm", type: "Ground", dice: ["Int", "Criar"], base: 10, notes: ['brn30', 'thunder'] },
    { name: "Lumina Crash", type: "Psychic", dice: ["Int", "Mover"], base: 8, notes: ['spdef100-2'] },
    { name: "Torch Song", type: "Fire", dice: ["Int", "Estrelar"], base: 8, notes: ['sound', 'spaup100'] },
    { name: "Make It Rain", type: "Steel", dice: ["Int", "Criar"], base: 12, notes: ['pay-day', 'spadown100'] },
    { name: "Hydro Steam", type: "Water", dice: ["Int", "Criar"], base: 8, notes: ['hydro-steam'] },
    { name: "Ruination", type: "Dark", dice: ["Int", "Forçar"], base: NaN, notes: ['half-dmg'] },
    { name: "Electro Drift", type: "Electric", dice: ["Int", "Mover"], base: 10, notes: ['collision-course'] },
    { name: "Chilling Water", type: "Water", dice: ["Int", "Criar"], base: 5, notes: ['atk100'] },
    { name: "Twin Beam", type: "Psychic", dice: ["Int", "Criar"], base: 4, notes: ['multihit2'] },
    { name: "Armor Cannon", type: "Fire", dice: ["Int", "Atirar"], base: 12, notes: ['defdown100', 'spdefdown100'] },
    { name: "Blood Moon", type: "Normal", dice: ["Int", "Criar"], base: 14, notes: ['overwhelming', 'recharge'] },
    { name: "Matcha Gotcha", type: "Grass", dice: ["Int", "Criar"], base: 8, notes: ['absorb2', 'brn20'] },
    { name: "Syrup Bomb", type: "Grass", dice: ["Int", "Atirar"], base: 6, notes: ['syrup-bomb'] },
    { name: "Electro Shot", type: "Electric", dice: ["Int", "Atirar"], base: 13, notes: ['charge', 'spaup100', 'electro-shot'] },
    { name: "Fickle Beam", type: "Dragon", dice: ["Int", "Criar"], base: NaN, notes: ['fickle-beam'] },
    { name: "Thunderclap", type: "Electric", dice: ["Int", "Criar"], base: 7, notes: ['sucker-punch'] },
    { name: "Tachyon Cutter", type: "Steel", base: 5, notes: ['multihit2', 'always-hits'] },
    { name: "Alluring Voice", type: "Fairy", dice: ["Int", "Estrelar"], base: 8, notes: ['sound', 'alluring-voice'] },
    { name: "Psychic Voice", type: "Psychic", dice: ["Int", "Estrelar"], base: 7, notes: ['sound', 'heal-block'] },
    { name: "Malignant Chain", type: "Poison", dice: ["Int", "Criar"], base: 10, notes: ['tox50'] }
];